...
WebUI.callTestCase(findTestCase('DemoTest1/Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard  nopCommerce administration/p_Products'))

WebUI.click(findTestObject('Object Repository/Page_Products  nopCommerce administration/a_Logout'))
