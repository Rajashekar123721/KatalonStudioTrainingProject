...
WebUI.verifyTextPresent('ABC123', false, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_asdsadsadsadsad sad'))
