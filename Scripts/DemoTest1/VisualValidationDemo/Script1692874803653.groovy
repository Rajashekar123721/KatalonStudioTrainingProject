...
CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('DemoTestOne')

WebUI.click(findTestObject('Object Repository/Page_Applitools/a_diff2'))

CustomKeywords.'com.kms.katalon.keyword.applitools.BasicKeywords.checkWindow'('DemoTestTwo')
